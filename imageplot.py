...
def plotlog(imagefile):
	...
	plt.xticks([]), plt.yticks([])
	plt.subplot(162),plt.imshow(logblur1.astype('uint8')),plt.title(kern+" ,5,0.55")
	plt.xticks([]), plt.yticks([])
	plt.subplot(163),plt.imshow(logblur2.astype('uint8')),plt.title(kern+" ,5,0.6")
	plt.xticks([]), plt.yticks([])
	plt.subplot(164),plt.imshow(logblur3.astype('uint8')),plt.title(kern+" ,5,0.65")
	plt.xticks([]), plt.yticks([])
	plt.subplot(165),plt.imshow(logblur4.astype('uint8')),plt.title(kern+" ,5,0.7")
	plt.xticks([]), plt.yticks([])
	plt.subplot(166),plt.imshow(logblur5.astype('uint8')),plt.title(kern+" ,5,0.75")
	plt.xticks([]), plt.yticks([])
	plt.show()
plotlog("1.jpg")